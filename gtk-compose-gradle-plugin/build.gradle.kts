...
gradlePlugin {
    plugins {
        ...
        register("compose") {
            ...
            implementationClass = "dev.petuska.gtk.compose.gradle.plugin.ComposePlugin"
        }
    }
}

buildConfig {
    packageName("dev.petuska.gtk.compose.gradle.plugin")
    useKotlinOutput {
...
//gradlePluginConfig {
//    pluginId = "dev.petuska.gtk.compose"
//    implementationClass = "dev.petuska.gtk.compose.ComposePlugin"
...
//    displayName = "GTK Compose Gradle Plugin"
//    description = "GTK Compose Gradle plugin for easy configuration"
//    artifactId = "gtk-compose-gradle-plugin"
//}
//
//val buildConfigDir
